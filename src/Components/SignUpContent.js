...
const SignUpContent = () => {
  ...
  const onSubmit = (e) => {
    ...
    // const SignUpContent = async (e) => {
    //   e.preventDefault();
    //   try {
    //     await axios.post(`${process.env.REACT_APP_BACKEND_URL}/user_register`, {
    //       name: "name",
    //       email: "email",
    //       password: "password",
    //     });
    ...
    <section className="vh-100">
      <Container fluid>
        <Row>
          ...
          <Col sm={6} className="">
            <div className="px-5 ms-xl-5 mt-2">
              <h1
            ...
            {/* onSubmit={SignUpContent} */}
            <Form className="w-75 mx-auto" onSubmit={(e) => onSubmit(e)}>
